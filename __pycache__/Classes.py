...
class Person():
    def __init__ (self, name, age, favoureddrink):
        self.name = name
        self.age = age
        self.favoureddrink = favoureddrink


class Round_Handler():
    def __init__(self):
        self.previous_rounds = []
        self.Table_Handler = TableHandler("Table_Handler_Rounds")
            ...
            if menu_in == list_of_inputs[0]:
                ...
                while True:
                    ...
                    while counter <len(previous):
                        while True:                    
                            self.Table_Handler.print_query(previous[counter])
